...
const useAdminData = (activeTab, selectedStudio) => {
    ...
    // Fungsi untuk mengurutkan data secara terpisah agar tidak mempengaruhi state asli
    ...
    }, [activeTab, selectedStudio, fetchPosts, fetchBookings, fetchAllBookings, fetchPackages, fetchCustomers]);
